...
if ($paygatedotto_kadomoney_currency === 'USD') {
        $paygatedotto_kadomoney_minimumcheck_final_total = $amount;
		} else {
$paygatedotto_kadomoney_minimumcheck_response = file_get_contents('https://api.paygate.to/control/convert.php?value=' . $amount . '&from=' . strtolower($paygatedotto_kadomoney_currency));


$paygatedotto_kadomoney_minimumcheck_conversion_resp = json_decode($paygatedotto_kadomoney_minimumcheck_response, true);

if ($paygatedotto_kadomoney_minimumcheck_conversion_resp && isset($paygatedotto_kadomoney_minimumcheck_conversion_resp['value_coin'])) {
    // Escape output
    $paygatedotto_kadomoney_minimumcheck_final_total	= $paygatedotto_kadomoney_minimumcheck_conversion_resp['value_coin'];      
} else {
...
if ($paygatedotto_kadomoney_minimumcheck_final_total < 15) {
