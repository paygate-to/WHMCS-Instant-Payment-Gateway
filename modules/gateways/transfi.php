...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://checkout.paygate.to/process-payment.php?address=' . $paygatedotto_transficom_gen_addressIn . '&amount=' . $paygatedotto_transficom_final_total . '&provider=transfi&email=' . urlencode($email) . '&currency=' . $paygatedotto_transficom_currency;
