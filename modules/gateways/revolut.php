...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://checkout.paygate.to/process-payment.php?address=' . $paygatedotto_revolutcom_gen_addressIn . '&amount=' . $paygatedotto_revolutcom_final_total . '&provider=revolut&email=' . urlencode($email) . '&currency=' . $paygatedotto_revolutcom_currency;
