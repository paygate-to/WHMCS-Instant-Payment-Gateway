...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://checkout.paygate.to/process-payment.php?address=' . $paygatedotto_simplexcom_gen_addressIn . '&amount=' . $paygatedotto_simplexcom_final_total . '&provider=simplex&email=' . urlencode($email) . '&currency=' . $paygatedotto_simplexcom_currency;
