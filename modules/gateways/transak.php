...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://' . $customDomain . '/process-payment.php?address=' . $paygatedotto_transakcom_gen_addressIn . '&amount=' . $paygatedotto_transakcom_final_total . '&provider=transak&email=' . urlencode($email) . '&currency=' . $paygatedotto_transakcom_currency;
