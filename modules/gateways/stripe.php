...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://' . $customDomain . '/process-payment.php?address=' . $paygatedotto_stripecom_gen_addressIn . '&amount=' . $paygatedotto_stripecom_final_total . '&provider=stripe&email=' . urlencode($email) . '&currency=' . $paygatedotto_stripecom_currency;
