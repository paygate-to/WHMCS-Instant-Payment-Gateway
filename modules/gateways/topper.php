...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://' . $customDomain . '/process-payment.php?address=' . $paygatedotto_topperpaycom_gen_addressIn . '&amount=' . $paygatedotto_topperpaycom_final_total . '&provider=topper&email=' . urlencode($email) . '&currency=' . $paygatedotto_topperpaycom_currency;
