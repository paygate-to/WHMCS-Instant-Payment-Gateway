...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://' . $customDomain . '/process-payment.php?address=' . $paygatedotto_guardariancom_gen_addressIn . '&amount=' . $paygatedotto_guardariancom_final_total . '&provider=guardarian&email=' . urlencode($email) . '&currency=' . $paygatedotto_guardariancom_currency;
